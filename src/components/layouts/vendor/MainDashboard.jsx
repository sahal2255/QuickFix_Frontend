      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <Card title="Total Clients" icon={Users} value="1,234" footer="+10% from last month" />
            <Card title="Active Projects" icon={Briefcase} value="42" footer="+5% from last month" />
            <Card title="Total Revenue" icon={IndianRupee} value="₹543,210" footer="+15% from last month" />
            <Card title="Upcoming Meetings" icon={Calendar} value="8" footer="Next 7 days" />
          </div>
